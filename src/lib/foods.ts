...
export const BAD_FOODS: FoodGroup[] = [
  ...
  {
    category: "精製油 / 高飽和脂肪加工品",
    emoji: "🍟",
    items: [
      {
        name: "奶精（咖啡奶精、奶茶用奶精）",
        note: "成分主要是精製植物油+糖+乳化劑；部分品牌仍含反式脂肪，看標示",
      },
      {
        name: "植物性奶油 / 酥油 / 起酥油",
        note: "傳統反式脂肪來源，配方雖多已改善但仍是高飽和脂肪/精製油",
      },
      {
        name: "炸雞、薯條、鹽酥雞、天婦羅",
        note: "麵衣吸油，反覆高溫煎炸油會產生氧化物",
      },
      {
        name: "速食套餐",
        note: "薯條+奶昔+漢堡組合多是高熱量、高鈉、高添加糖，反式脂肪要看標示",
      },
      { name: "微波爆米花、洋芋片", note: "部分品牌仍含氫化油，看成分表跟營養標示" },
    ],
  },
  {
    category: "隱形糖陷阱",
